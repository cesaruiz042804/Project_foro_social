...
Route::options('{any}', function (Request $request) {
    // Orígenes permitidos
    $allowedOrigins = ['http://localhost:5173', 'https://api-foro-social.myhostingspace.net'];

    $origin = $request->headers->get('Origin'); // Verifica si el origen de la solicitud está permitido
